...
function get_knapsack_value(products, capacity) {
  console.log("PRODUTCSSDADDASDADA", products, capacity)
  ...
  console.log("SOLUTION", solution,quantity_itens, capacity)
  chosen_products = []
  total_weight = 0
